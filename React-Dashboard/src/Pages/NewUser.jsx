        ...
        <div className="flex-4 p-10">
            ...
            <form className="flex flex-wrap justify-between" action="">
                ...
                <div className="mt-10 w-[400px] flex flex-row items-center ml-5">
                    <label className=" ml-10 text-base text-gray-700 " >جنسیت</label>
                    <div className="">
                        <input className="" type="radio" placeholder="" name="" id="male" />
                        <label className="m-3 text-lg text-gray-700" for="male">مونث</label>
                        <input className="" type="radio" placeholder="" name="" id="female" />
                        <label className="m-3 text-lg text-gray-700" for="female">مذکر</label>
                    </div>
                </div>
                <div className="w-[400px] flex flex-col mt-3 ml-5">
                    <label className="mb-3 text-base text-gray-700 " >فعالیت</label>
                    <select className="h-10 rounded-md pr-2" name="" id="">
                        <option value="yes">بله</option>
                        <option value="no">خیر</option>
                    </select>
                </div>
                <button className="p-1 w-52 h-10 mt-12 rounded-md bg-violet-600 text-white"> ایجار کاربر</button>
            </form>
        </div>
    );
};

        ...
        <div>
            ...
            <div className="p-5">
                ...
                <div className="flex items-center p-5 justify-between">
                    ...
                    <div className="">
                        <span className="cursor-pointer underline ml-5">سبد خرید({cart.products.length})</span>
                ...
                <div className=" flex justify-between">
                        ...
                        {cart.products.map((product)=>(
                            ...
                            <div className="flex-2 flex">
                                ...
                                <div className="p-5 flex flex-col justify-between">
                                    <div className="N"><b>محصول: </b>{product.title}</div>
                                    <div className="I"><b>کد: </b>{product._id}</div>
                                    <div className="w-[20px] h-[20px] rounded-full" style={{background: product.color }}></div>
                                    <div className="S"><b>سایز: </b>{product.size}</div>
                                </div>
                            </div>
                            <div className="flex-1 flex items-center justify-center flex-col ">
                                <div className="flex items-center">
                                    <Add/>
                                    <div className="text-center text-[24px]">{product.quantity}</div>
                                    <Remove/>
                                </div>
                                <div className="mt-5 text-[24px] ">{Intl.NumberFormat().format(product.price)} ریال</div>
                            </div>
                        </div>))}
                    ...
                    <div className=" border-1 border-solid justify-center items-center mr-5 border-pink-400/50 rounded-lg p-5 h-[50vh]" style={{flex:"1"}}>
                        ...
                        <div className="my-7 mx-0 justify-between flex">
                            ...
                            <span className="">{Intl.NumberFormat().format(cart.total)} ریال</span>
                        </div>
                        <div className="my-7 mx-0 justify-between flex">
                            <span className="">تخفیف شما از خرید</span>
                            <span className="">{Intl.NumberFormat().format(cart.discount)} ریال</span>
                        </div>
                        <div className="my-7 mx-0 justify-between flex font-[600]">
                            <span className=""> مجموع</span>
                            <span className="">{Intl.NumberFormat().format(cart.total+cart.discount)} ریال</span>
                        </div>
